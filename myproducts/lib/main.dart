    ...
    return Row(
      ...
      children: <Widget>[
        Container(
          ...
          child: IconButton(
            icon:(rating >= 1 ? Icon(Icons.star, size: size,):Icon(Icons.star_border, size: size,)),
        ...
        Container(
          padding: EdgeInsets.all(0),
          child: IconButton(
            icon:(rating >= 2 ? Icon(Icons.star, size: size,):Icon(Icons.star_border, size: size,)),
            color:Colors.red[500] ,
        ...
        Container(
          padding: EdgeInsets.all(0),
          child: IconButton(
            icon:(rating >= 3 ? Icon(Icons.star, size: size,):Icon(Icons.star_border, size: size,)),
            color:Colors.red[500] ,
